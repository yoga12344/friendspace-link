...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('BACKLOG', 'TODO', 'IN_PROGRESS', 'REVIEW', 'COMPLETED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MESSAGE', 'MENTION', 'TASK_ASSIGNED', 'TASK_COMPLETED', 'TASK_DUE', 'EVENT_INVITE', 'FILE_SHARED', 'DOCUMENT_UPDATED', 'WORKSPACE_INVITE', 'FRIEND_REQUEST');
...
CREATE TABLE "NotificationPreference" (
    ...
    "fileShared" BOOLEAN NOT NULL DEFAULT true,
    "documentUpdated" BOOLEAN NOT NULL DEFAULT true,
